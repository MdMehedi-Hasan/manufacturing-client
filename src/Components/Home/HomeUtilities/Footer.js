...
const Footer = () => {
    return (
        <div>
            <footer className="footer p-10 py-24 bg-amber-500 text-white text-base-content">
                <div>
            ...
            <footer className="footer px-10 py-14 border-t bg-black  text-white border-base-300">
                <div className="items-center grid-flow-col">
                <Icon width="40" icon="entypo:tools" />
                    <p> Wrench &amp; Screw <br />Providing reliable products since 2020-{new Date().getFullYear()}</p>
                </div>
