...
const Summary = () => {
    return (
        <div className='bg-white my-52' style={{ backgroundImage: `url('${map}')`, backgroundRepeat: 'no-repeat', backgroundSize: 'cover' }}>
            <div className='container mx-auto'><h1 className='lg:w-2/4 text-4xl lg:ml-14 ml-5 py-12' data-aos="zoom-out-right" data-aos-duration="1000">Our professional team works to increase productivity and cost effectiveness on the market.</h1>
