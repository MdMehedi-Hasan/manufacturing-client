    ...
    return (
        <div className='bg-sky-900'>
            <div className='flex justify-between h-96 text-white items-end' style={{backgroundImage:`url(${shape})`,backgroundSize:'cover'}}>
                <div className='mb-36 lg:ml-20'><h1 className='text-4xl mb-5 font-bold' data-aos="fade-right" data-aos-duration="1000">Hi, I am Md. Mehedi Hasan.</h1>
                <p className='text-2xl' data-aos="fade-right" data-aos-delay="1000" data-aos-duration="1000">I am a full stack web developer.I use MERN stack to develope apps.</p></div>
            ...
            <div className='grid grid-cols-4 gap-10 mb-28'>
                <div className="card-body text-6xl mx-auto bg-transparent max-w-sm hover:translate-y-4">
            ...
            <div>
                <h1 className='text-4xl text-white pb-5 ml-40 pt-36'>Personal information</h1>
                <div className='pb-5 ml-40 text-white'><span className=' fontbold text-2xl'>Name: </span><span> Md. Mehedi Hasan</span></div>
                <div className='pb-5 ml-40 text-white'><span className=' fontbold text-2xl'>Email: </span><span> mh19115@gmail.com</span></div>
                <div className='pb-5 ml-40 text-white'><span className=' fontbold text-2xl'>Education: </span> B.B.A honours (Undergraduate)<span></span></div>
